...
def noticia(fala):
	try:
		if "politica" in fala:
			web.get(caminho_navegador).open("https://www.google.com/search?q=noticias+politica")
			return"Mostrando resultados da pesquisa por {}".format(fala)
		else:
			web.get(caminho_navegador).open("https://www.google.com/search?q={}".format(fala))
			return"Mostrando resultados da pesquisa por {}".format(fala)
	except:
		return "houve um erro"
